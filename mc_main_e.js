...
var uis={ 
	...
	eFont:"Arial",mFont:"\"Myanmar Text\",Padauk,\"Myanmar MN\",\"Droid Sans\"MON3 Anonta 1,Myanmar3,Tharlon,Arial"
};
//-------------------------------------------------------------------------
		...
		str+="<td class='TdHTable TdH8'>\
			...
			onchange='DisplayUI(4)' title='Language'>\
				...
				<option value='Myanmar'  "+((u.Lang=="Myanmar")?"selected":"")+
					">Myanmar </option> \
				<option value='NMon'  "+((u.Lang=="NMon")?"selected":"")+
					">NMon </option>\
				<option value='UniMon'  "+((u.Lang=="UniMon")?"selected":"")+
					">UniMon </option>\
...
function initc(hmo){ uis.hmo=hmo||0; //parameter to hide mobile option
	...
	if (uis.Lang===undefined) {
		...
		else if (F=="Zawgyi-One") L="NMon";
		else if (F=="Zawgyi-One") L="UniMon";
...
function UIContent(u) {
	...
	if (u.Lang=="Zawgyi") cFont="Zawgyi-One";
    else if (u.Lang=="NMon") cFont="Zawgyi-One";
	else if (u.Lang=="UniMon") cFont="Zawgyi-One";	//if Zawgyi font is selected
...
function m2str(my,myt,mm,mmt,mp,d,wd){
	...
	var hmpa=["လဆန်း","လပြည့်","လဆုတ်","လကွယ်"];
...
function jd2mstr(jd,rf){
	...
	str+=" "+n2ms(n)+" မိနစ်၊ "+n2ms(s)+" စက္ကန့် ";
